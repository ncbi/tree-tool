...
struct ThisApplication : Application
{
	ThisApplication ()
      ...
      // Output	    
  	  ...
  	  addKey ("qual", "Print the summary gain/loss statistics measured by feature consistency, save gain/loss statistcis per feature in the indicated file, line format: <feature> +<gaines> -<losses> / <genomes> (<optional genomes>)");
