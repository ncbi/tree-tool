...
*
* File Description:
*   Split a DNA multi-fasta file into a set of fasta files each containing one sequence
*
*/
...
{
  ThisApplication ()
    : Application ("Split a DNA multi-fasta file into a set of fasta files each containing one sequence")
  	{
